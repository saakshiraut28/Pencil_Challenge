...
const Team = ({ Org }) => {
  return Org.map((organization) => (
    <>
      <section className="py-20 pb-32 bg-gradient-to-r from-indigo-100 via-red-100 to-yellow-100 rounded-xl shadow-xl my-5">
        <div className="relative max-w-6xl px-10 mx-auto">
          <div className="flex flex-col items-start justify-start mb-12">
            <h2 className="inline-block mb-2 mr-5 text-4xl font-extrabold tracking-tight ">
          ...
          <div className="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
            <div className="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <a href="#_" className="focus:outline-none">
                  ...
                  <p className="text-sm bg-gradient-to-r from-indigo-400 via-red-400 to-yellow-400 font-bold bg-clip-text text-transparent truncate uppercase">
                    Admin
                  </p>
                </a>
              </div>
              <div className="flex-1 flex-grow-0 pr-2 text-gray-200">
                <div className="relative flex items-center justify-end space-x-3">
                  <a href="#_" className="text-gray-500 hover:text-gray-700">
                    <svg
              ...
              <div className="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  <a href="#_" className="focus:outline-none">
                    ...
                    <p className="text-sm text-gray-700 truncate">COO</p>
                  </a>
                </div>
                <div className="flex-1 flex-grow-0 pr-2 text-gray-200">
                  <div className="relative flex items-center justify-end space-x-3">
            ...
            <div className="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
              <div className="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
                <div className="flex-shrink-0 mr-4">
                  <img
                    className="w-16 h-16 rounded-full"
                    src="https://images.unsplash.com/photo-1544348817-5f2cf14b88c8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=face&w=800&h=800&q=80"
                    alt="poasopjasofpasd"
                  />
                </div>
                <div className="flex-1 min-w-0">
                  <a href="#_" className="focus:outline-none">
                    ...
                    <p className="text-sm text-gray-700 truncate">Co-Founder</p>
                  </a>
                </div>
                <div className="flex-1 flex-grow-0 pr-2 text-gray-200">
                  <div className="relative flex items-center justify-end space-x-3">
            ...
            <div className="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
              <div className="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
                <div className="flex-shrink-0 mr-4">
                  <img
                    className="w-16 h-16 rounded-full"
                    src="https://images.unsplash.com/photo-1582337832132-b1df9234f9cb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=face&w=800&h=800&q=80"
                    alt="adoasdiasjdoasjkd"
                  />
                </div>
                <div className="flex-1 min-w-0">
                  <a href="#_" className="focus:outline-none">
            ...
            <div className="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
              <div className="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
                <div className="flex-shrink-0 mr-4">
                  <img
                    className="w-16 h-16 rounded-full"
                    src="https://images.unsplash.com/photo-1575299899528-a8a3dbcefc29?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&h=800&crop=face&q=80"
                    alt="uihhiuiugg"
                  />
                </div>
                <div className="flex-1 min-w-0">
                  <a href="#_" className="focus:outline-none">
                    ...
                    <p className="text-sm text-gray-700 truncate">Designer</p>
                  </a>
                </div>
                <div className="flex-1 flex-grow-0 pr-2 text-gray-200">
                  <div className="relative flex items-center justify-end space-x-3">
